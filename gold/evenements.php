<?php
/**
 * Événements - CIA Invest Gold V2
 * Calendrier et gestion des événements
 * 
 * @package CIA_Invest
 * @version 2.0
 */
    ...
    <style>
        * {
        ...
        .event-header {
            ...
            position: relative;
            height: 180px;
            background: linear-gradient(135deg, var(--event-color-1), var(--event-color-2));
            display: flex;
            align-items: center;
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <div class="menu-section">
                ...
                <a href="evenements.php" class="menu-item orange active">
    ...
    <div class="dashboard-container">
        ...
        <div class="row">
            <!-- Event 1 -->
            <div class="col-lg-6">
                <div class="event-card" style="--event-color-1: #3b82f6; --event-color-2: #2563eb;">
                    <div class="event-header">
                        <div class="event-date-badge">
                            <div class="event-day">28</div>
                            <div class="event-month">Oct 2025</div>
                        </div>
                    </div>
                    <div class="event-body">
                        <h3 class="event-title">Séminaire de Formation sur le Pitch</h3>
                        <span class="event-type webinar">
                            <i class="bi bi-camera-video"></i> Webinaire
                        </span>
                        
                        <p class="event-description">
                            Apprenez à créer un pitch percutant pour convaincre les investisseurs. 
                            Session interactive avec des experts en levée de fonds.
                        </p>
            ...
            <!-- Event 2 -->
            <div class="col-lg-6">
                <div class="event-card" style="--event-color-1: #8b5cf6; --event-color-2: #7c3aed;">
                    <div class="event-header">
                        <div class="event-date-badge">
                    ...
                    <div class="event-body">
                        <h3 class="event-title">Atelier Business Model Canvas</h3>
                        <span class="event-type workshop">
                            <i class="bi bi-briefcase"></i> Atelier
                        </span>
                        
                        <p class="event-description">
                            Structurez votre modèle d'affaires avec le Business Model Canvas. 
                            Atelier pratique avec coaching personnalisé.
                        </p>
            ...
            <!-- Event 3 -->
            <div class="col-lg-6">
                <div class="event-card" style="--event-color-1: #ec4899; --event-color-2: #db2777;">
                    <div class="event-header">
                        <div class="event-date-badge">
                    ...
                    <div class="event-body">
                        <h3 class="event-title">Soirée Networking Entrepreneurs</h3>
                        <span class="event-type networking">
                            <i class="bi bi-people"></i> Networking
                        </span>
                        
                        <p class="event-description">
                            Rencontrez d'autres entrepreneurs, investisseurs et mentors dans une ambiance conviviale. 
                            Opportunités de partenariats et échanges d'expériences.
                        </p>
            ...
            <!-- Event 4 -->
            <div class="col-lg-6">
                <div class="event-card" style="--event-color-1: #10b981; --event-color-2: #059669;">
                    <div class="event-header">
                        <div class="event-date-badge">
                    ...
                    <div class="event-body">
                        <h3 class="event-title">Conférence : Financement Participatif</h3>
                        <span class="event-type webinar">
                            <i class="bi bi-camera-video"></i> Webinaire
                        </span>
                        
                        <p class="event-description">
                            Découvrez comment le crowdfunding peut accélérer votre croissance. 
                            Témoignages de succès et stratégies pratiques.
                        </p>
