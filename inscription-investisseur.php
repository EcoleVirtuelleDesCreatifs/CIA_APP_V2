<?php
/**
 * Page Inscription Investisseur - CIA Invest
 * 
 * Formulaire d'inscription pour les investisseurs (Obligataire, Actionnaire)
 * 
 * @package CIA_Invest
 * @version 1.0
 */
...
$current_page = 'inscription-investisseur';
$page_title = 'Inscription Investisseur';

// Détecter le type d'investisseur
$investor_type = isset($_GET['type']) ? $_GET['type'] : 'obligataire';
...
$config = [
    'obligataire' => [
        ...
        'benefits' => [
            ...
            ['icon' => 'bi-cash-stack', 'title' => 'Revenus Réguliers', 'desc' => 'Intérêts fixés versés périodiquement'],
            ['icon' => 'bi-graph-up', 'title' => 'Rendement Prévisible', 'desc' => 'Taux de retour garanti dès le départ']
        ],
        'color' => '#0891b2'
    ],
    'actionnaire' => [
        ...
        'benefits' => [
            ...
            ['icon' => 'bi-trophy', 'title' => 'Dividendes Attractifs', 'desc' => 'Part des bénéfices de l’entreprise'],
            ['icon' => 'bi-people', 'title' => 'Droit de Vote', 'desc' => 'Participez aux décisions stratégiques']
        ],
        'color' => '#198754'
    ]
];

$current_config = $config[$investor_type];
    ...
    <div class="container">
        <div class="row justify-content-center mb-4">
            <div class="col-lg-10 text-center" data-aos="fade-up">
                <h2 class="section-title mb-3">Pourquoi investir en <?php echo $investor_type == 'obligataire' ? 'Obligataire' : 'Actionnaire'; ?> ?</h2>
                <p class="section-description">Découvrez les avantages exclusifs de ce type d'investissement</p>
            </div>
        </div>
...
<section class="registration-section py-5">
    <div class="container">
        ...
        <div class="row justify-content-center mb-5">
            <div class="col-lg-10 text-center" data-aos="fade-up">
                <span class="section-badge">Inscription Investisseur</span>
                <h2 class="section-title">Devenez Investisseur CIA</h2>
                <p class="section-description">Complétez le formulaire ci-dessous pour devenir investisseur</p>
            </div>
        </div>

        <!-- Two Column Layout -->
        <div class="row justify-content-center">
            <!-- Left Column - Investor Type Display (Sticky) -->
            <div class="col-lg-4 col-md-5 mb-4 mb-lg-0" data-aos="fade-right">
                <div class="plan-display-sticky">
                    <div class="card">
                        <div class="card-body text-center" id="selectedInvestorDisplay">
                            <!-- Investor type details will be inserted here by JavaScript -->
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-7 col-md-7" data-aos="fade-left" data-aos-delay="100">
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form id="investorRegistrationForm">
                            ...
                            <h5 class="mb-3 mt-4"><i class="bi bi-cash-stack me-2"></i>Informations d'investissement</h5>
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <label for="investmentAmount" class="form-label">Montant d'investissement envisagé (USD) <span class="text-danger">*</span></label>
                                    <select class="form-select" id="investmentAmount" required>
                                        ...
                                        <option value="1000000+">Plus de 1 000 000 USD</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <!-- Interest Sectors -->
                            <div class="mb-4">
                                <label class="form-label">Secteurs d'intérêt <span class="text-danger">*</span></label>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="interestSectors" value="agriculture" id="sector1">
                                            <label class="form-check-label" for="sector1">Agriculture</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="interestSectors" value="industrie" id="sector2">
                                            <label class="form-check-label" for="sector2">Industrie</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="interestSectors" value="services" id="sector3">
                                            <label class="form-check-label" for="sector3">Services</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="interestSectors" value="technologie" id="sector4">
                                            <label class="form-check-label" for="sector4">Technologie</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="interestSectors" value="finance" id="sector5">
                                            <label class="form-check-label" for="sector5">Finance</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="interestSectors" value="immobilier" id="sector6">
                                            <label class="form-check-label" for="sector6">Immobilier</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="interestSectors" value="energie" id="sector7">
                                            <label class="form-check-label" for="sector7">Énergie</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="interestSectors" value="commerce" id="sector8">
                                            <label class="form-check-label" for="sector8">Commerce</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="interestSectors" value="autre" id="sector9">
                                            <label class="form-check-label" for="sector9">Autre</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" id="motivation" rows="4" placeholder="Expliquez vos objectifs d'investissement et pourquoi vous souhaitez rejoindre CIA Invest..." required></textarea>
                            </div>
                ...
                <div class="text-center mt-4">
                    <a href="devenir-investisseur.php" class="btn btn-link">
                        <i class="bi bi-arrow-left me-2"></i>Retour aux options
                    </a>
                </div>
            </div>
        </div>
...
$extra_js = ['inscription-investisseur'];
// Inclure le footer
